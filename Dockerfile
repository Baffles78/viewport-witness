...
COPY --chown=pwuser:pwuser agents.html ./
COPY --chown=pwuser:pwuser docs/PRIVACY.md docs/TERMS.md ./docs/
COPY --chown=pwuser:pwuser assets/viewport-witness.png ./assets/
